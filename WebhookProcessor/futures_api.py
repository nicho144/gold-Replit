...
@api.post("/api/analyze", response_model=MarketAnalysis)
...
# This is for running the application directly through uvicorn
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("futures_api:api", host="0.0.0.0", port=8000, reload=True)